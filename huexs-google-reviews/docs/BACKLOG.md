# Backlog — funciones fuera del alcance del MVP
...
- Schema.org `Review` / `AggregateRating` (requiere revisión de políticas de Google/buscadores).
- Soporte Multisite.
- Importación/migración desde otros plugins de reseñas.
- Estadísticas avanzadas y análisis de sentimiento.
- Controles de estilo avanzados (tipografías, bordes, sombras por preset).
- Paquete de actualización privada (updater).
