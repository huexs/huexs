...
class SourceException extends \RuntimeException {
	...
	public function suggestedAction(): string {
		return match ( $this->errorCode ) {
			...
			'places_key_rejected' => __( 'Revisa tu clave en Google Cloud: que esté habilitada "Places API (New)" —no la antigua—, que el dominio de este sitio (o la IP del servidor) figure entre las restricciones permitidas, y que el proyecto tenga la facturación activa.', 'huexs-google-reviews' ),
