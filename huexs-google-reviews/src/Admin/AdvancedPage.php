<?php
/**
 * Pantalla Avanzado: proyecto propio de Google Cloud + OAuth directo, sin pasar por Huexs.
 *
 * Pensada para los sitios propios de Huexs y para clientes que no quieran depender
 * del servicio central. Solo se muestra con el modo avanzado activado.
 *
...
class AdvancedPage {
	...
	public function render(): void {
		...
		?>
		<div class="wrap">
			<h1><?php esc_html_e( 'Modo avanzado — Proyecto propio de Google Cloud', 'huexs-google-reviews' ); ?></h1>

			<div class="notice notice-info inline">
				<p><?php esc_html_e( 'En este modo el sitio habla directamente con Google usando tu propio proyecto de Google Cloud, sin pasar por la API de Huexs. Obtienes todas las reseñas, pero requiere que Google apruebe tu acceso a Business Profile API.', 'huexs-google-reviews' ); ?></p>
			</div>
			...
			<div class="hgr-admin-card">
						...
						<table class="form-table" role="presentation">
							...
							<tr>
								...
								<td>
									...
									<p class="description"><?php esc_html_e( 'Se guarda cifrado y no volverá a mostrarse completo.', 'huexs-google-reviews' ); ?></p>
								</td>
							</tr>
						</table>
				...
				<p style="margin-top:12px;">
					<?php esc_html_e( 'Redirect URI para Google Cloud:', 'huexs-google-reviews' ); ?><br />
			...
			<div class="hgr-admin-card">
				...
				<?php if ( $expired ) : ?>
					<p><span class="hgr-status-error"><?php esc_html_e( 'La conexión ha caducado. Reconecta.', 'huexs-google-reviews' ); ?></span></p>
				...
				<?php if ( $connected ) : ?>
					<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline-block;">
						...
						<?php submit_button( __( 'Cargar mis fichas de Google', 'huexs-google-reviews' ), 'secondary', 'submit', false ); ?>
					</form>
				<?php endif; ?>
			</div>
			...
			<div class="hgr-admin-card hgr-danger-zone">
				...
				<p><?php esc_html_e( 'Elimina los tokens OAuth y todas las reseñas y ubicaciones sincronizadas en este modo. No se puede deshacer.', 'huexs-google-reviews' ); ?></p>
				<form
					method="post"
					action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
					data-hgr-confirm="<?php esc_attr_e( '¿Desconectar Google y borrar los datos sincronizados?', 'huexs-google-reviews' ); ?>"
				>
